...
NotificationItem _notificationItemDeserialize(
  ...
  object.receivedAt = reader.readDateTime(offsets[2]);
...
extension NotificationItemQuerySortBy
  ...
  QueryBuilder<NotificationItem, NotificationItem, QAfterSortBy> sortByTopic() {
    return QueryBuilder.apply(this, (query) {
...
extension NotificationItemQuerySortThenBy
  ...
  QueryBuilder<NotificationItem, NotificationItem, QAfterSortBy> thenByTopic() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'topic', Sort.asc);
    });
  }
...
extension NotificationItemQueryWhereDistinct
  ...
  QueryBuilder<NotificationItem, NotificationItem, QDistinct> distinctByBody(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationItem, NotificationItem, QDistinct> distinctByTopic(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NotificationItemQueryProperty
  ...
  QueryBuilder<NotificationItem, String, QQueryOperations> bodyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationItem, String?, QQueryOperations> topicProperty() {
    return QueryBuilder.apply(this, (query) {
